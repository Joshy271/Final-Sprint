...
#IF hostage
   ...
   #move on to next room 3
    ...
    chassis_ctrl.rotate_with_degree(rm_define.clockwise, 1)
...
#IFFIRE
    chassis_ctrl.rotate_with_degree(rm_define.clockwise, 90)
    chassis_ctrl.move_with_distance(0, 4.00)
    chassis_ctrl.rotate_with_degree(rm_define.anticlockwise, 2)
    chassis_ctrl.move_with_distance(0, 1.32)
    ...
    chassis_ctrl.rotate_with_degree(rm_define.clockwise, 53)
    ...
    chassis_ctrl.move_with_distance(0, 2.68)
    chassis_ctrl.rotate_with_degree(rm_define.anticlockwise, 53)
    ...
    chassis_ctrl.rotate_with_degree(rm_define.clockwise, 1)
    chassis_ctrl.move_with_distance(0, 5.00)
    chassis_ctrl.move_with_distance(0, 0.60)
    ...
    chassis_ctrl.rotate_with_degree(rm_define.clockwise, 90)
    chassis_ctrl.move_with_distance(0, 0.30)

    #scan function
    scan_for_marker()
#if Hostage
    #leave room
    chassis_ctrl.move_with_distance(180, 0.30)
    chassis_ctrl.move_with_distance(90, 2.10)
    chassis_ctrl.move_with_distance(0, 2.40)
    chassis_ctrl.rotate_with_degree(rm_define.clockwise, 90)
    ...
    chassis_ctrl.move_with_distance(0, 5.00)
    chassis_ctrl.move_with_distance(0, 3.50)
